package com.cosmos.mark.sharpinject;

import android.app.Activity;
import android.view.View;

import com.cosmos.mark.sharpinject.annotation.EventBase;
import com.cosmos.mark.sharpinject.annotation.Bind;
...
public class SharpInject
{
	...
	private static void injectViews(Activity activity)
	{
		...
		{
			Bind viewInjectAnnotation = field
					.getAnnotation(Bind.class);
